...
export default function StatsCards({ stats: propStats }) {
  ...
  const cards = [
    {
      label: 'Total Nodes',
      value: stats.totalNodes ?? graphStats.totalNodes,
      icon: Share2,
      color: '#6366f1',
    ...
    {
      label: 'Relationships',
      value: stats.totalRelationships ?? graphStats.totalRelationships,
      icon: LinkIcon,
      color: '#818cf8',
    ...
    {
      label: 'Suppliers',
      value: stats.suppliers ?? graphStats.suppliers,
      icon: Package,
    ...
    {
      label: 'Manufacturers',
      value: stats.manufacturers ?? graphStats.manufacturers,
      icon: Factory,
    ...
    {
      label: 'Ports',
      value: stats.ports ?? graphStats.ports,
      icon: Anchor,
    ...
    {
      label: 'Products',
      value: stats.products ?? graphStats.products,
      icon: Box,
    ...
    {
      label: 'Countries',
      value: stats.countries ?? graphStats.countries,
      icon: Globe,
    ...
    {
      label: 'Warehouses',
      value: stats.warehouses ?? graphStats.warehouses,
      icon: Warehouse,
